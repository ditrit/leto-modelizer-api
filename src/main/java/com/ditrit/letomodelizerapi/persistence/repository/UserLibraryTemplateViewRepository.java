 ...
 */
public interface UserLibraryTemplateViewRepository extends JpaRepository<UserLibraryTemplateView, Long> {
     ...
     */
    Page<UserLibraryTemplateView> findAllByUserId(Long userId,
